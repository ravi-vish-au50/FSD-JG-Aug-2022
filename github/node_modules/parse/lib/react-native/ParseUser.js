  ...
  (0, _createClass2.default)(ParseUser, [{
    ...
    value: function () {
      var _save = (0, _asyncToGenerator2.default)(function* () {
        ...
        yield (0, _get2.default)((0, _getPrototypeOf2.default)(ParseUser.prototype), "save", this).apply(this, args);
    ...
    value: function () {
      var _destroy = (0, _asyncToGenerator2.default)(function* () {
        ...
        yield (0, _get2.default)((0, _getPrototypeOf2.default)(ParseUser.prototype), "destroy", this).apply(this, args);
        var current = yield this.isCurrentAsync();
    ...
    value: function () {
      var _fetch = (0, _asyncToGenerator2.default)(function* () {
        ...
        yield (0, _get2.default)((0, _getPrototypeOf2.default)(ParseUser.prototype), "fetch", this).apply(this, args);
        var current = yield this.isCurrentAsync();
    ...
    value: function () {
      var _fetchWithInclude = (0, _asyncToGenerator2.default)(function* () {
        ...
        yield (0, _get2.default)((0, _getPrototypeOf2.default)(ParseUser.prototype), "fetchWithInclude", this).apply(this, args);
        var current = yield this.isCurrentAsync();
